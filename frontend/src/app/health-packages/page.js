    ...
    <>
      ...
      <style>{`
        ...
        .hp-header {
          ...
          border-radius: 15px;
          color: white;
          box-shadow: 0 5px 15px rgba(11,122,196,0.3);
        }
        .hp-header h1 {
          font-size: 3rem;
          font-weight: 700;
        ...
        .hp-modal-details p { margin: 0 0 0.5rem 0; }
        .hp-modal-details p:last-child { margin: 0; }
        .hp-form {
          display: grid;
          gap: 1rem;
        }
        ...
        .hp-confirm-btn:hover { background-color: #059669; }

        /* Mobile breakpoints */
        @media (max-width: 768px) {
          .hp-outer { padding: 1rem 0.5rem; }
          .hp-container { padding: 1rem; border-radius: 12px; }
          .hp-header { padding: 1.5rem 1rem; margin-bottom: 1.5rem; border-radius: 12px; }
          .hp-header h1 { font-size: 2rem; }
          .hp-header p { font-size: 1rem; }
          .hp-grid {
            grid-template-columns: 1fr;
            gap: 1.25rem;
          }
          .hp-card { padding: 1.25rem; }
          .hp-card-body h3 { font-size: 1.4rem; }
          .hp-card-price { font-size: 1.2rem; }
          .hp-modal { padding: 1.25rem; border-radius: 12px; }
          .hp-modal-header h3 { font-size: 1.3rem; }
        }

        @media (max-width: 480px) {
          .hp-header h1 { font-size: 1.6rem; }
          .hp-header p { font-size: 0.95rem; }
          .hp-card { padding: 1rem; }
          .hp-card-body h3 { font-size: 1.25rem; }
          .hp-modal { padding: 1rem; }
          .hp-form input,
          .hp-form textarea { font-size: 0.95rem; padding: 0.7rem; }
          .hp-book-btn,
          .hp-confirm-btn { font-size: 1rem; padding: 0.85rem; }
        }
      `}</style>
        ...
        <div className="hp-container">
          ...
          <div className="hp-grid">
            {packages.map((pkg, index) => (
              <article key={pkg.name} className="hp-card">
                {/* Package Badge */}
                <div
                  className="hp-badge"
                  style={{
                    backgroundColor:
                      index === 0 ? '#10b981' : index === 1 ? '#f59e0b' : '#8b5cf6'
                  }}
                >
                  Popular
                </div>
          ...
          >
            ...
            >
              ...
              <div className="hp-modal-details">
                ...
                <p style={{ fontWeight: 'bold', color: '#0b7ac4', fontSize: '1.2rem' }}>
